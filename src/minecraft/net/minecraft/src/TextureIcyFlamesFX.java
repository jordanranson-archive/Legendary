...
public class TextureIcyFlamesFX extends TextureFX
{
    protected float[] field_76869_g = new float[320];
    protected float[] field_76870_h = new float[320];

    public TextureIcyFlamesFX(int par1)
    {
        super(Block.icyFire.blockIndexInTexture + par1 * 16);
    }
    ...
    public void onTick()
    {
        ...
        for (var3 = 0; var3 < 256; ++var3)
        {
            ...
            int var8 = (int)(var4 * var4 * var4 * 255.0F);
            short var9 = 255;
            ...
            this.imageData[var3 * 4 + 0] = (byte)var8;
