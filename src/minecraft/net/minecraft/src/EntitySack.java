...
public class EntitySack extends EntityThrowable
{
	...
	public ItemStack getSackContents(String sackType)
	{
		...
		else if(sackType == "treasure")
		{
			...
			treasure[8] = Item.malachite;
			treasure[9] = Item.opal;
			treasure[10] = Item.goldenCarrot;
			treasure[11] = Item.enderPearl;
			treasure[12] = Item.dustyRelic;
		...
		else
		{
			...
			junk[32] = Item.cannonball;
			junk[33] = Item.cannonballHeavy;
			junk[34] = Item.cannonballExplosive;
