...
public class BlockIcyFire extends Block
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            boolean var6 = par1World.getBlockId(par2, par3 - 1, par4) == Block.blockSnow.blockID;
            ...
            {
                par1World.setBlockWithNotify(par2, par3, par4, Block.snow.blockID);
            }
            else
            {
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
		...
		if(par5Entity instanceof EntityLiving)
		{
			...
			entity.addPotionEffect(new PotionEffect(Potion.frozen.id, 20 * 4, 0));
			par1World.setBlockWithNotify(par2, par3, par4, 0);
			par1World.playSound((double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), "random.fizz", par1World.rand.nextFloat() * 0.3F, par1World.rand.nextFloat() * 0.3F);
		}
    }
}
