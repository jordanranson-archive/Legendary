...
public class EntityChargedStrikeFX extends EntityFX
{
    ...
    public EntityChargedStrikeFX(World par1World, Entity par2Entity)
    {
        this(par1World, par2Entity, "crit");
    }

    public EntityChargedStrikeFX(World par1World, Entity par2Entity, String par3Str)
    {
