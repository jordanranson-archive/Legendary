...
public class EntityGrapplingHook extends Entity
{
    ...
    public EntityGrapplingHook(World par1World)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public EntityGrapplingHook(World par1World, double par2, double par4, double par6, EntityPlayer par8EntityPlayer)
    {
        this(par1World);
        this.setPosition(par2, par4, par6);
        this.ignoreFrustumCheck = true;
        this.angler = par8EntityPlayer;
        par8EntityPlayer.grapplingEntity = this;
    }

    public EntityGrapplingHook(World par1World, EntityPlayer par2EntityPlayer)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
        ...
        this.angler.grapplingEntity = this;
        this.setSize(0.25F, 0.25F);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.angler.isDead || !this.angler.isEntityAlive() || var1 == null || var1.getItem() != Item.grapplingHook || this.getDistanceSqToEntity(this.angler) > 1024.0D)
                {
                    this.setDead();
