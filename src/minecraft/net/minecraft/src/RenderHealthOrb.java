...
public class RenderHealthOrb extends Render
{
    public RenderHealthOrb()
    {
     ...
     * Renders the XP Orb.
     */
    public void renderTheXPOrb(EntityHealthOrb par1EntityXPOrb, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderTheXPOrb((EntityHealthOrb)par1Entity, par2, par4, par6, par8, par9);
    }
}
