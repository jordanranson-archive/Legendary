...
public class StructureMineshaftPieces
{
    ...
    private static final WeightedRandomChestContent[] mineshaftChestContents = new WeightedRandomChestContent[] {
		...
		new WeightedRandomChestContent(Item.roughStone.shiftedIndex, 0, 1, 4, 10),
		new WeightedRandomChestContent(Item.hugeGeode.shiftedIndex, 0, 1, 2, 5),
		new WeightedRandomChestContent(Item.dustyRelic.shiftedIndex, 0, 1, 1, 1),
